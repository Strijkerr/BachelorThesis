...
def main () :
    ...
    print("Distribution courts (future references): ",Counter(courts).most_common())
    print("Top 10 most common anchor texts in future references: ",Counter(anchor).most_common(10))
    print("Count2: ",count)
    print("Distribution courts (all): ",Counter(courts2).most_common())
main()
